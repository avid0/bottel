...
class PropertyDefinition
{
        ...
        $baseNamespace = '')
    {
        ...
        if ($this->propType === 'LazyJsonMapper') {
            $this->propType = '\\'.DelayedJsonMapper::class;
        }
        ...
        try {
            ...
            // The target class or its parents MUST inherit DelayedJsonMapper,
            ...
            // plain "DelayedJsonMapper" objects. It's a very bad idea, since
            // they don't get any property definitions, and therefore their
            // object would be unreliable. But that's the user's choice.
            if ($fullClassPath !== DelayedJsonMapper::class
                && !$reflector->isSubClassOf('\\'.DelayedJsonMapper::class)) {
                throw new BadPropertyDefinitionException(sprintf(
            ...
            // to be a DelayedJsonMapper, and normalized into its correct name.
            // ... Rock on! ;-)
