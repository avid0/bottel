...
namespace Bottel\Utils\DelayedJsonMapper\Property;

use Bottel\Utils\DelayedJsonMapper\Exception\BadPropertyDefinitionException;
use Bottel\Utils\DelayedJsonMapper\Exception\BadPropertyMapException;
use Bottel\Utils\DelayedJsonMapper\Exception\CircularPropertyMapException;
        ...
        if (is_string($propName) && is_string($propDefStr)) {
            ...
            if (is_int($propName) && is_string($propDefStr)) {
                ...
                if (class_exists($strictImportClassName)
                    && is_subclass_of($strictImportClassName, '\\'.DelayedJsonMapper::class)) {
                    ...
                    // of DelayedJsonMapper (we don't bother allowing to import
                    // DelayedJsonMapper itself, since it is the lowest possible
