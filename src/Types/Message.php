 ...
 */
class Message extends DelayedJsonMapper {
    use MessageManager;
    ...
    public function _init(){
        ...
        if($forward_from_chat = $this->_getProperty('forward_from_chat')){
            $this->_setProperty('forward_type', $forward_from_chat->type);
        }elseif($this->_hasPropertyData('forward_from') || $this->_hasPropertyData('forward_sender_name')){
            $this->_setProperty('forward_type', 'private');
        }
    }
}